...
public class Strings1 {
    ...
    */
    public String lastChars(String a, String b) {
      return a.length() > 0 ? 
      a.substring(0,1) +  (b.length() > 0 ? b.substring(b.length()-1) : "@") :
    ...
    */
    public String deFront(String str) {
      return str.substring(0,1).equals("a") ?
              str.substring(1,2).equals("b") ? str: "a" + str.substring(2) :
    ...
    public String withoutX(String str) {
      return str.length() > 1 &&
          ...
          str.substring(str.length()-1).equals("x") ?
            ...
            str.length() > 0 && str.substring(0,1).equals("x") ?
              str.substring(1) : 
              str.length() > 0 && str.substring(str.length()-1).equals("x") ?
