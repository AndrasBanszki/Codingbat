...
public class Logic1 {
    ...
    */
    public String alarmClock(int day, boolean vacation) {
      switch(day){
        case 5 : return !vacation ? "7:00" : "10:00"; 
        case 1 : return !vacation ? "7:00" : "10:00";
        case 2 : return !vacation ? "7:00" : "10:00"; 
        case 3 : return !vacation ? "7:00" : "10:00";
        case 4 : return !vacation ? "7:00" : "10:00";
        case 6 : return !vacation ? "10:00" : "off";
        case 0 : return !vacation ? "10:00" : "off";
    ...
    */
    ...
    if both tea and candy are at least 5. However, if either tea or candy is at 
    ...
    */
    public String fizzString(String str) {
      return str.substring(0,1).equals("f") ?
    ...
    remainder be when one number divides evenly into another? (See also: 
    ...
    */
    public int withoutDoubles(int die1, int die2, boolean noDoubles) {
      return !noDoubles ?
        die1 + die2 :  
        (die1 == 6 ) || (die2 == 6) ?  1 + 6 : 
            (die1 == die2 ) ? die1 + die2 + 1 : die1 +die2;
    ...
    */
    ...
    1, or 2. If they are all the value 2, the result is 10. Otherwise if they are all the same, the result is 5. Otherwise so long as both b and c are different from a, the result is 1. Otherwise the result is 0.
